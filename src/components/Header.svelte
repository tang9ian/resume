  ...
  <div class="flex flex-col gap-2">
    ...
    <div class="flex gap-4">
      <a
        ...
        ><svg viewBox="0 0 24 24" class="h-5 w-5" astro-icon="mdi:link"
          ><path
            fill="currentColor"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        ><svg viewBox="0 0 24 24" class="h-5 w-5" astro-icon="mdi:github"
          ><path
            fill="currentColor"
      ...
      <a href={`mailto: ${contact.email}`} class="flex items-center gap-1"
        ><svg viewBox="0 0 24 24" class="h-5 w-5" astro-icon="mdi:email"
          ><path
            fill="currentColor"
